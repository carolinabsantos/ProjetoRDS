...
def writeBroadcastRules(p4info_helper, ingress_sw, dst_ip_addr, mcast_grp):
    ...
    table_entry = p4info_helper.buildTableEntry(
        table_name="MyIngress.arp_request_table",
        match_fields={
...
def writeForwardingToHostRules(p4info_helper, ingress_sw, dst_ip_addr, port):
    ...
    table_entry = p4info_helper.buildTableEntry(
        ...
        action_name="MyIngress.forward_host",
        action_params={
            "port"      : port
        })
    ingress_sw.WriteTableEntry(table_entry)
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        writeBroadcastRules(p4info_helper, ingress_sw=s1, dst_ip_addr="10.0.100.20", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s1, dst_ip_addr="10.0.100.30", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s1, dst_ip_addr="10.0.100.40", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s2, dst_ip_addr="10.0.100.10", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s2, dst_ip_addr="10.0.100.30", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s2, dst_ip_addr="10.0.100.40", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s3, dst_ip_addr="10.0.100.10", mcast_grp=1)
        writeBroadcastRules(p4info_helper, ingress_sw=s3, dst_ip_addr="10.0.100.20", mcast_grp=1)

        writeForwardingToHostRules(p4info_helper, ingress_sw=s1, dst_ip_addr="10.0.100.10", port=3)
        writeForwardingToHostRules(p4info_helper, ingress_sw=s2, dst_ip_addr="10.0.100.20", port=3)
